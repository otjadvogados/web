...
export type FontFamily = `'Merriweather', 'Public Sans', sans-serif` | `'Inter', sans-serif` | `'Inter', 'Public Sans', sans-serif` | `'Poppins', sans-serif` | `'Roboto', sans-serif` | `'Public Sans', sans-serif` | `'Montserrat', sans-serif` | `'Montserrat', 'Public Sans', sans-serif`;
